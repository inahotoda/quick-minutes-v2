...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Hiragino Sans', sans-serif; color: #333; line-height: 1.8;">
  <p>お疲れ様です。</p>
  <p>本日の会議の文脈を解析し、ネクストアクションと決定事項をPDFに集約しています。<br>
  添付のファイルをご確認ください。</p>
  <p>思考の鮮度が落ちないうちに、次の一歩へ繋げましょう。</p>
  <br>
  <p style="color: #999; font-size: 12px; margin-top: 24px;">- Generated by INAHO Quick Minutes v2 (Gemini-3.0-Flash)</p>
</body>
</html>`;
